...
#    Updated: 2017/12/18 22:54:36 by miclaude         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

SRCS =ft_memset.c ft_bzero.c ft_memccpy.c ft_memchr.c \
  ft_memcmp.c ft_memcpy.c ft_memmove.c ft_strlen.c \
  ...
  ft_isprint.c ft_toupper.c ft_tolower.c ft_strlcat.c\
